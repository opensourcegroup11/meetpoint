    ...
    return (
      <main className="min-h-screen bg-[#F5F5F5] flex flex-col">
        <header className="w-full flex items-center justify-between px-12 py-4 bg-white shadow-sm">
          ...
          <button className="bg-[#5B5BD6] text-white px-5 py-2 rounded-lg">sungeun</button>
        </header>
        <div className="flex gap-6 px-12 py-8">
          ...
          <div className="bg-white rounded-2xl flex flex-col flex-1 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              ...
              <a href="/map" className="border border-[#5B5BD6] text-[#5B5BD6] px-4 py-1 rounded-lg text-sm">
                지도에서 위치 확인
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-4 border-t border-gray-100">
              <input type="text" placeholder="메세지를 입력하세요." className="flex-1 border border-gray-200 rounded-lg px-4 py-2 outline-none text-sm" />
